...
// Icon components as functions to avoid JSX in non-component files
export const createDribbbleIcon = () => (
...
export const createBehanceIcon = () => (
  <svg className="w-4 h-4 text-black" fill="currentColor" viewBox="0 0 24 24">
...
export const createProfile = (overrides: Partial<PersonProfile>): PersonProfile => ({
  ...defaultProfile,
  ...overrides,
});

// Utility function to create custom project links
export const createProjectLinks = (customProjects: Partial<Record<string, Partial<ProjectLink>>>): ProjectLink[] => {
