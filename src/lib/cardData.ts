...
// Common social media icons (as React components)
...
export const createDesignerProfile = (overrides: Partial<PersonProfile> = {}): PersonProfile => ({
  name: "Alex Johnson",
...
export const createDeveloperProfile = (overrides: Partial<PersonProfile> = {}): PersonProfile => ({
  name: "Sarah Chen",
...
export const createFreelancerProfile = (overrides: Partial<PersonProfile> = {}): PersonProfile => ({
  name: "Mike Rodriguez",
...
export const createDesignerLinks = (baseUrls: Partial<Record<string, string>> = {}): ProjectLink[] => [
  {
    id: "dribbble",
    title: "Dribbble",
...
export const createDeveloperLinks = (baseUrls: Partial<Record<string, string>> = {}): ProjectLink[] => [
  {
    id: "github",
    title: "GitHub",
    ...
    imageUrl: "https://images.unsplash.com/photo-1556075798-4825dfaaf498?w=400&h=240&fit=crop",
    projectDetails: "Explore my open source contributions, personal projects, and code samples. See how I approach problem-solving and software architecture.",
  },
  {
    id: "portfolio",
    title: "Portfolio",
    ...
    projectDetails: "View live applications and websites I've built. From frontend interfaces to full-stack applications, see my development skills in action.",
  },
  {
    id: "linkedin",
    title: "LinkedIn",
...
export const createSocialLinks = (baseUrls: Partial<Record<string, string>> = {}): ProjectLink[] => [
  {
    id: "linkedin",
    title: "LinkedIn",
    description: "Professional Network",
  ...
  },
  {
    ...
    projectDetails: "Follow me for industry insights, project updates, and thoughts on design and technology. Join the conversation!",
  },
  {
    id: "instagram",
    title: "Instagram",
    ...
    projectDetails: "Get a glimpse behind the scenes of my creative process, workspace, and day-to-day inspiration.",
  },
  {
    id: "email",
    title: "Email",
