...
interface EditableDigitalCardProps {
...
interface EditableDigitalCardRef {
...
// Main Component
const EditableDigitalCard = forwardRef<
  EditableDigitalCardRef,
  EditableDigitalCardProps
>(({ profile, isEditing, onEdit, onSave, onCancel, onProfileChange }, ref) => {
            ...
            <div className="flex-1 p-4">
              ...
              <div className="flex flex-col md:flex-row md:items-start gap-4 mb-4">
                <EditableProfileImage
                  ...
                  isEditing={isEditing}
                  onImageChange={(url) =>
                    handleProfileFieldChange("profileImage", url)
                  }
                />
                ...
                <div className="flex-1 min-w-0 text-center md:text-left">
                  ...
                  >
                    <EditableField
                      ...
                      isEditing={isEditing}
                      onChange={(value) =>
                        handleProfileFieldChange("name", value)
                      }
              ...
              <div className="mb-4" onClick={(e) => e.stopPropagation()}>
                <EditableField
                  value={profile.bio}
                  isEditing={isEditing}
                  onChange={(value) => handleProfileFieldChange("bio", value)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <EditableContactInfo
                  ...
                  isEditing={isEditing}
                  onChange={(value) =>
                    handleProfileFieldChange("location", value)
                  }
              ...
              <EditableSkills
                ...
                isEditing={isEditing}
                onChange={(skills) =>
                  handleProfileFieldChange("skills", skills)
                }
              />
            </div>
...
EditableDigitalCard.displayName = "EditableDigitalCard";

export default EditableDigitalCard;
